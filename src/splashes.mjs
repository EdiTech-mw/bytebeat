export const splashes = [
    ...
    "But you can call it DOLLCHAN#",
    "Sorry, we've had to block all access from your cat's network<br>because it was used to watch orange cat videos.<br><br>Please tell your cat to contact us.",
    "Concieved in 2022!",
    "Revived in 2024!",
    "We're back! Dang...",
    "Woo, r/bytebeat!",
    ...
    "DON'T SKID ME PLEASE I BEG OF YOU<br>I HAVE A WIFE AND FAMILY<br><br>(Seriouisly, just don't. It's rude. It's rude to everyone except you.)",
    "Creator of Diagram! (Not combined)",
    "Creator (and DESTROYER) of triads!",
    "Creator of the zoom indicator!",
    "With anti-skid tech! (skidding is rude to everyone except the skid.)",
    "96kHz samplerate!",
    "Cookie?",
    "Change is OK!",
